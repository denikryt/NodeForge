...
| `run_lsystem_syntax_and_guard_checks()` | `tests/unit/lsystem/test_validation.py`, `tests/blender/lsystem/test_syntax_contracts.py`, `tests/blender/lsystem/test_validation_errors.py` |
...
| `run_lsystem_documented_contract_checks()` | `tests/unit/lsystem/test_backend_selection.py`, `tests/blender/lsystem/test_backend_exports.py`, `tests/blender/lsystem/test_documented_examples.py` |
