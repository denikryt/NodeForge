...
_BUILTIN_NAMES = set(_FLOAT_FUNCS_1) | set(_FLOAT_FUNCS_2) | set(_VECTOR_MATH_FLOAT_OUTPUT) | set(_VECTOR_MATH_VECTOR_OUTPUT_1) | set(_VECTOR_MATH_VECTOR_OUTPUT_2) | {
    ...
    "set_position", "output", "store", "mod", "frac", "map_range", "sign", "range", "cube", "copy_by_offsets", "join", "transform", "polyline", "realize_instances", "input_geometry", "input_float", "input_int", "input_bool", "input_vector"
}
